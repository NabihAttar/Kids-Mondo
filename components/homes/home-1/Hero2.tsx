        ...
        <div className="mxd-hero-01">
          <div className="mxd-hero-01__wrap loading-wrap">
              ...
              <div className="mxd-hero-01__title-wrap">
                ...
                <h1 className="hero-01-title">
                  ...
                  <span className="hero-01-title__row loading__item">
                    ...
                    <em className="hero-01-title__item">Is a New Role to Play</em>
                  </span>
                </h1>
              </div>
            </div>
            ...
            <div className="mxd-hero-01__bottom">
              <div className="mxd-hero-01__data-wrap">
                ...
                <div className="mxd-hero-01__data-descr loading__fade">
                  <p className="t-bright" style={{ color: "black" }}>
                    In KidzMondo, every visit is an adventure. One day your child
                    is a doctor, the next a pilot, reporter, or artist.
                    <br />
                    <br />
                    Each experience is designed to ignite curiosity, teach
                    responsibility, and celebrate creativity because the best
                    way to learn is to live it.
                  </p>
                </div>
              ...
              {/* ✅ VIDEO BLOCK (hidden on mobile via CSS) */}
              <div className="mxd-hero-01__video-wrap loading__item heroVideoDesktopOnly">
                <video
